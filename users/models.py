...
class Profile(models.Model):  # now register Profile to admin on admin.py
    ...
    def save(self):
        super().save()  # Running the save() Of parent class.. save() method already exists in parent class..It's function is to automatically save the anything when it is called
